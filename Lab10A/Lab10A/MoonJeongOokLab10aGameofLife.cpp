// Lab 10A, Game Of Life Simulation
// Jeong Ook Moon
...
int hashFunction(const Cell &rv_cell)
{
	return ((13*rv_cell.row) + (7*rv_cell.col));
}
#include "MoonJeongOokLab10aHashTable.h"

HashTable<char, Cell, 1009> grid(hashFunction);// Older grid of life
HashTable<char, Cell, 1009> newGrid(hashFunction); // New grid for storing the next generation
