// Lab 9b, Game Of Life Simulation
// Jeong Ook Moon
...
#include "MoonJeongOokLab09bAssociativeArray.h"

Array<char, Cell> grid; // Older grid of life
Array<char, Cell> newGrid; // New grid for storing the next generation
