// ZhangYingyingLab10aGameOfLife10a.cpp
// Yingying Zhang
// on 11/03/2015
// Editor(s) used: X Code
// Compiler(s) used: X Code
// The Game of Life File
...
HashTable<char, cell, 1009> grid(hashCode); // Older grid of life
HashTable<char, cell, 1009> newGrid(hashCode); // New grid for storing the next generation
